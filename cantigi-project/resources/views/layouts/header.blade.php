    ...
    <div class="container mx-auto px-6 lg:px-8">
      ...
      <div class="flex items-center space-x-2 mb-4 md:mb-0">
        ...
        <div class="flex space-x-3">
          <a href="{{ route('login') }}" class="hidden sm:block border border-green-500 text-green-600 px-6 py-2 rounded-lg hover:bg-green-100 transition-all duration-300 font-medium">
            Masuk
          </a>
          <a href="{{ route('register') }}" class="bg-green-600 text-white px-6 py-2 rounded-lg hover:bg-green-700 transition-all duration-300 font-medium shadow-lg hover:shadow-xl">
            Daftar
          </a>
        </div>
      </div>
