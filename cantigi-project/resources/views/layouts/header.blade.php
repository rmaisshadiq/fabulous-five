      ...
      <div class="px-6 py-4 space-y-4">
        ...
        @endif
          ...
          <a href="{{ route('profile.edit') }}"
            class="block w-full text-left px-3 py-2 text-gray-700 hover:text-green-600 hover:bg-green-50 rounded-lg transition-all duration-200">
            Profile
          </a>
        ...
        @endif
          ...
          <form method="POST" action="{{ route('logout') }}">
            @csrf
            <button type="submit"
            class="block w-full text-left px-3 py-2 text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg transition-all duration-200">
            Log Out
            </button>
          </form>
          </div>
