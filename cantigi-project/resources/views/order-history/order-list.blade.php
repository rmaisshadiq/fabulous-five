                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="flex items-center justify-between mb-4">
                                                ...
                                                <span class="px-4 py-2 rounded-full text-sm font-semibold
                                                    ...
                                                    @elseif($order->status == 'ongoing') bg-gradient-to-r from-purple-100 to-purple-50 text-purple-800 border border-purple-200
                                                    ...
                                                    <i class="fas fa-circle text-xs mr-1
                                                        ...
                                                        @elseif($order->status == 'ongoing') text-purple-500
