    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-8 lg:gap-12 mt-4 md:mt-8 lg:mt-12">
            ...
            <div class="vehicle-card bg-white rounded-3xl  w-full sm:w-64 md:w-72 lg:w-80 xl:w-96 mb-8">
                <div class="vehicle-image-container bg-green-500 rounded-tl-[60px] sm:rounded-tl-[90px] rounded-bl-[20px] sm:rounded-bl-[30px] rounded-tr-[20px] sm:rounded-tr-[30px] rounded-br-[60px] sm:rounded-br-[90px] flex items-center justify-center overflow-hidden shadow-lg">
