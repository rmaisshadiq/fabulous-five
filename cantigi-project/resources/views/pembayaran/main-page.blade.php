...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
    <div class="container mx-auto px-4 py-8">
        ...
        <!-- Form dengan action dan method -->
        <form action="{{ route('payment.store') }}" method="POST" id="paymentForm">
            @csrf
            <!-- Hidden field untuk order_id - sesuaikan dengan cara Anda mengirim order_id -->
            ...
            <div class="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div class="bank-option relative">
                                    <input type="radio" id="bca" name="bank" value="bca" class="peer sr-only" required>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="card_holder_name" placeholder="Nama Lengkap" 
                        ...
                        <input type="hidden" name="amount" value="169000">

                        <!-- Checkbox -->
                        <div class="mt-6">
                            <label class="flex items-center">
                                <input type="checkbox" name="save_card" value="1" class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8">
                    ...
                    <!-- Tombol Bayar -->
                    <button type="submit" id="payButton" class="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold py-4 px-6 rounded-lg hover:from-blue-700 hover:to-blue-800 transform hover:scale-105 transition-all duration-200 shadow-lg">
